...
class LocalCardapioDataSourceTest {
    ...
    @Test
    fun `loadMenuItems deve carregar e parsear JSON corretamente`() = runTest {
        // Given
        val jsonContent = """
            [
                {
    ...
    @Test
    fun `loadMenuItems deve retornar lista vazia quando JSON é array vazio`() = runTest {
        // Given
        val jsonContent = "[]"
        val inputStream = ByteArrayInputStream(jsonContent.toByteArray())
        whenever(mockAssetManager.open("menu.json")).thenReturn(inputStream)
    ...
    @Test
    fun `loadMenuItems deve lançar exceção quando arquivo não existe`() = runTest {
        // Given
        whenever(mockAssetManager.open("menu.json")).thenThrow(RuntimeException("Arquivo não encontrado"))
    ...
    @Test
    fun `loadMenuItems deve lançar exceção quando JSON é inválido`() = runTest {
        // Given
    ...
    @Test
    fun `loadMenuItems deve lançar exceção quando JSON é null`() = runTest {
        // Given
        val nullJson = "null"
    ...
    @Test
    fun `loadMenuItems deve parsear JSON com campos opcionais`() = runTest {
        // Given
        val jsonContent = """
            [
                {
    ...
    @Test
    fun `loadMenuItems deve parsear JSON com muitos itens`() = runTest {
        // Given
    ...
    @Test
    fun `loadMenuItems deve parsear JSON com preços decimais`() = runTest {
        // Given
        val jsonContent = """
            [
                {
    ...
    @Test
    fun `loadMenuItems deve fechar InputStream corretamente`() = runTest {
        // Given
        val jsonContent = """[]"""
        val inputStream = ByteArrayInputStream(jsonContent.toByteArray())
        whenever(mockAssetManager.open("menu.json")).thenReturn(inputStream)
