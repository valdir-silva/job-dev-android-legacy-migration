...
class GetMenuItemByIdUseCaseTest {
    ...
    @Test
    fun `invoke should return Success when item exists`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return Error when item not found`() =
        runTest {
            // Given
    ...
    @Test
    fun `invoke should return Error when id is invalid negative`() =
        runTest {
            // When
            val results = useCase.invoke(-1).toList()
    ...
    @Test
    fun `invoke should return Error when id is zero`() =
        runTest {
            // When
