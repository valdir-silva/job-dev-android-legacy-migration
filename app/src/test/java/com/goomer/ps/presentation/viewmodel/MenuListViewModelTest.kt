...
class MenuListViewModelTest {
    ...
    @Test
    fun `quando carregar menu com sucesso, deve emitir Loading e depois Success`() =
        runTest {
            // Given
            val items =
                listOf(
    ...
    @Test
    fun `quando erro ao carregar menu, deve emitir Failure`() =
        runTest {
            // Given
    ...
    @Test
    fun `quando carregar menu vazio, deve emitir Success com lista vazia`() =
        runTest {
            // Given
